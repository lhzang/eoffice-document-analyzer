...
<template>
  <div v-if="props.selectedDoc" class="mt-6 flex items-center gap-4">
    <span class="text-primary w-75 font-semibold whitespace-nowrap">
      Văn bản chỉnh sửa <span class="text-red-500">*</span>:
    </span>
    <span class="w-80">
      <AppFileInput name="newMainFile" :multiple="false" class="mt-4" required accept=".pdf" />
    </span>
  </div>
