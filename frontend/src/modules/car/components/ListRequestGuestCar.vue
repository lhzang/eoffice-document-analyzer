...
import { useGetRequestGuestCarList } from '../composables/queries/carList/useGetRequestGuestCarList'
...
const { data, isLoading } = useGetRequestGuestCarList(
  () =>
    cleanObject({
...
<template>
  ...
  <ModalDetailRequestCar
    ...
    @processed-guest-car="handleAfterProcessGuestCar"
  />
</template>
