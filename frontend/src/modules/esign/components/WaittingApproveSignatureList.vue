...
import { useGetWaitApproveSignatureList } from '../composables/signature-approve/useGetWaitApproveSignatureList'
...
const { data, isLoading, refetch } = useGetWaitApproveSignatureList(() =>
  cleanObject({
