...
import { useGetWaitProcessInternalDocList } from '../composables/queries/useGetWaitProcessInternalDocList'
...
const { data, isLoading, refetch } = useGetWaitProcessInternalDocList(
  () => ({
    ...props.filterParams,
