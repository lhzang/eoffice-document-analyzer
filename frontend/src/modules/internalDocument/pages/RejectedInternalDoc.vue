...
import RejectedOutDocTable from '../components/RejectedInternalDocTable.vue'

const { filterParams, handleFilter } = useOutdocCommonFilter()
</script>
...
<template>
  <div class="h-full">
    ...
    <div class="mt-8">
      <RejectedOutDocTable :filterParams="filterParams" />
    </div>
  </div>
</template>
