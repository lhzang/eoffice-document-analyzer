...
const handleSelectUnitForPosition = (selectedUnit: TUnitSelectValue | null) => {
  setFieldValue('staffUnit', selectedUnit)
  setFieldValue('hasUnit', !!selectedUnit)
}

const onSubmit = handleSubmit((values) => {
  confirm.require({
    group: 'modalAddNewStaff',
...
<template>
  ...
  >
    <form @submit="onSubmit">
      <div class="grid grid-cols-12 gap-4">
        ...
        <InternalUnitSelect
          ...
          type="FULL"
          @submit="handleSelectUnitForPosition"
    ...
    <ConfirmDialog group="modalAddNewStaff" />
  </AppModal>
</template>
