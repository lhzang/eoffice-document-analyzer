...
watchEffect(() => console.log(permissionFilter, 'permissionFilter'))
...
const handleOpenModalSelectStaff = () => {
  if (disabled) return
  tempInternalStaff.value = cloneDeep(internalStaff.value) ?? null
...
const handleConfirmSelect = () => {
  ...
  internalStaff.value = cloneDeep(tempInternalStaff.value)
