...
import { cleanObject, isEmptyValue } from '@/shared/utils/common'
...
type TEmits = {
  (event: 'submit', value: TCommonOutdocFilter | null): void
  (event: 'update:visible', value: boolean): void
}

const props = defineProps<{
  placeholder?: string
  filterValues: TCommonOutdocFilter
}>()

const { placeholder = 'Trích yếu/Số ký hiệu/Nơi gửi...' } = props
...
const searchValue = ref<string>(props?.filterValues?.search ?? '')
  ...
  <div>
    ...
    >
      ...
      <div class="relative flex items-center justify-center">
        ...
        />
        <div
          v-if="isEmptyValue(convertFormData) === false"
